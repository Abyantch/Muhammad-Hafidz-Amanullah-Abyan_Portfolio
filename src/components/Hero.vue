...
<template>
  <div id="Hero" class="bg-white dark:bg-slate-950">
    <div class="mx-auto mt-[6.5rem] max-w-6xl py-6 sm:px-6 sm:py-1 lg:px-8">
      <div class="relative isolate overflow-hidden max-h-[40] max-lg:[40rem] max-sm:[20rem] bg-sky-500 dark:bg-sky-700 px-6 pt-16 hover:shadow-2xl rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0 hover:scale-105 transition duration-500 flex">
        ...
        <div class="relative sm:my-auto h-auto lg:ml-20 flex justify-center items-center lg:flex lg:items-center">
          <img class="relative mx-auto max-w-full p-10 object-contain sm:max-w-auto" src="/src/assets/CTO.png" alt="App screenshot" />
        </div>
      </div>
